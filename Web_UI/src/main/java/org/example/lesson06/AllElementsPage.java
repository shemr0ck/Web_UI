...
public class AllElementsPage extends AbstractPage{
    ...
    private static final String login = "test_gb";
    private static final String password = "1301Skpol";
    public static final String checkUrl = "https://test-gb.livejournal.com/checklist/summer2023";
